...
(defun getPrimeFactorsForNumber(number)
  ...
  (let ((result nil) (numberToDivide (abs number)) (primeFactors (make-hash-table)) (primesUntilNumber nil)) ; key = prime number, value = number of occurrences within the numberToDivide (power exponent)
