...
(defun requestContainerParams()
  (let ((result nil))
    ...
    (let ((containerName nil) (containerCapacity nil))
...
(defun main()
  ...
  (terpri)
  (let ((tankCapacity (requestIntInputWithCondition "Enter the requested tank capacity (press ENTER to quit): " #'(lambda(val)(let ((isGreater nil))(setq isGreater (> val 0)))) "The number should be strictly positive. Please try again")))
    (terpri)
