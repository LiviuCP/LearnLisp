...
(defun main()
  (let ((first nil) (second nil)) ; declare both variables here to have a better overview
    ...
    (if (not (null second))
	(let ((gcd (gCommonDiv first second)) (lcm nil)) ; we will declare l.c.m. here to have a better overview
