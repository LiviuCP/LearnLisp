  ...
  (loop
   ...
   (let ((input (read-line)))
     ...
     (cond ((= (length input) 0) (write-line "You exited") (return))
	   ((convert-string-to-integer input) (write-line "The entered string is an integer value"))
	   ((convert-string-to-float input) (write-line "The entered string is a float value"))
